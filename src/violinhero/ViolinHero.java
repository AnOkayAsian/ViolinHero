...
// draw border
       ...
       if (playing)
       {
           ...
           // drawImage(noteIMG, tempXPos-(noteIMG.getWidth(this)/2), tempYPos,noteIMG.getWidth(this),noteIMG.getHeight(this), this);
            ...
            g.fillRect(0, 0, Math.abs(bowXPos+800/getWidth2()), 100); 
            ...
            // g.drawString("temp y pos"+tempYPos, 50, 300);
...
public void fillAMousePointerFourth(Graphics2D g,double xscale,double yscale,
double rot,int x,int y)
{
   ...
   int xvals[]={0,2,2,-2,-2,0};
   int yvals[]={-10,-6,0,0,-6,-10};
...
public void drawAMousePointerFourth(Graphics2D g,double xscale,double yscale,
double rot,int x,int y)
{
   g.translate(x,y);
   g.rotate(rot  * Math.PI/180.0);
...
public void drawMousePointer(Graphics2D g,double xscale,double yscale,
double rot,int x,int y)
{
   g.translate(x,y);
   g.rotate(rot  * Math.PI/180.0);
   ...
   fillAMousePointerFourth(g,1,1,0,0,12);//down
   fillAMousePointerFourth(g,1,1,180,0,-12);//up
   fillAMousePointerFourth(g,1,1,90,-12,0);//left
   fillAMousePointerFourth(g,1,1,270,12,0);//right
   g.setColor(Color.BLACK);
   drawAMousePointerFourth(g,1,1,0,0,12);//down
   drawAMousePointerFourth(g,1,1,180,0,-12);//up
   drawAMousePointerFourth(g,1,1,90,-12,0);//left
   drawAMousePointerFourth(g,1,1,270,12,0);//right
...
public void drawCannon(Graphics2D g,double xscale,
double yscale,double rot,int x,int y)
{
   g.translate(x,y);
   g.rotate(rot  * Math.PI/180.0);
   g.scale( xscale , yscale );

//   int xvals[] = {0,10,10,-10,-10};
//   int yvals[] = {-15,-10,10,10,-10};
//   g.setColor(Color.red);
//   g.fillPolygon(xvals, yvals, xvals.length);
   g.setColor(Color.LIGHT_GRAY);
            int xvals2[]={0,1,5,3,-3,-5,-1,0};
            int yvals2[]={-11,-9,3,5,5,3,-9,-11};
            g.fillPolygon(xvals2,yvals2,xvals2.length-1);

            Color redish = new Color(209,14,53);
        g.setColor(redish);
            int xvals[]={-2,-1,-1,-2,-2,-3,-5,-2};
            int yvals[]={-6,-4,0,4,5,5,3,-6};
            g.fillPolygon(xvals,yvals,xvals.length-1);


            int xvals3[]={2,1,1,2,2,3,5,2};
            int yvals3[]={-6,-4,0,4,5,5,3,-6};
            g.fillPolygon(xvals3,yvals3,xvals3.length-1);

            g.setColor(Color.DARK_GRAY);
            int xvals4[]={-1,1,2,2,1,-1,-2,-2,-1};
            int yvals4[]={2,2,4,6,7,7,6,4,2};
            g.fillPolygon(xvals4,yvals4,xvals4.length-1);
...
public void drawCannon2(Graphics2D g,double xscale,
double yscale,double rot,int x,int y)
{
   g.translate(x,y);
   g.rotate(rot  * Math.PI/180.0);
...
public void drawPower(Graphics2D g,double xscale,double yscale,
double rot,int x,int y)
{
   g.translate(x,y);
   g.rotate(rot  * Math.PI/180.0);
...
/////////////////////////////////////////////////////////////////////////
    public void animate() {
        ...
        if(redBarXPos+((bowDir)*20)>=0 && redBarXPos+((bowDir)*20)<WINDOW_WIDTH)
            redBarXPos=redBarXPos+((bowDir)*20);
